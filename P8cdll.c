...
static Node* new_node( int x ) //ya esta
{
 ...
 * @pre La lista NO debe estar vacía
 */
int CDLL_Back( CDLL* this )  //ya esta
{
...
void CDLL_Insert( CDLL* this, int item ) //insertar a la derecha del cursor
{
   ...
   {
      //guardamos el previo de el elemento donde esta el cursor
      ...
      //conectamos el nuevo nodo con sus hermanos
	   tmp_Prev_cursor->next = n;

      n->prev = tmp_Prev_cursor;
